...
namespace Boff.Blog.Application.Caching.Authorize.Impl
{
    public class AuthorizeCacheService : CachingServiceBase, IAuthorizeCacheService
    {
        ...
        /// <returns></returns>
        public async Task<string> GetLoginAddressAsync(Func<Task<string>> factory)
        {
        ...
        /// <param name="factory"></param>
        /// <returns></returns>
        public async Task<string> GetAccessTokenAsync(string code, Func<Task<string>> factory)
        {
        ...
        /// <param name="factory"></param>
        /// <returns></returns>
        public async Task<string> GenerateTokenAsync(string access_token, Func<Task<string>> factory)
        {
